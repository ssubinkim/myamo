    ...
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="center">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center pb-[10px] pt-[100px] relative size-full">
          ...
          <MalBox />
          <P />
          <div className="absolute content-stretch flex items-center left-[181px] size-[20px] top-[359px]" data-name="oranges">
          ...
          <div className="absolute content-stretch flex items-center left-[231px] size-[23px] top-[490px]" data-name="oranges">
            <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Gemini_Generated_Image_grxp12grxp12grxp-Photoroom 1">
              <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <img alt="" className="absolute h-[122.07%] left-[-12.87%] max-w-none top-[-8.96%] w-[124.82%]" src={imgGeminiGeneratedImageGrxp12Grxp12GrxpPhotoroom1} />
              </div>
...
export default function IntroSplash() {
  return (
    <div className="bg-[#fff7ef] content-stretch flex flex-col gap-[10px] items-start overflow-clip relative rounded-[49px] size-full" data-name="intro_splash4">
      <FixBar />
      <Center />
      <div className="absolute content-stretch flex items-center left-[221px] size-[20px] top-[555px]" data-name="oranges">
        <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Gemini_Generated_Image_grxp12grxp12grxp-Photoroom 1">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[122.07%] left-[-12.87%] max-w-none top-[-8.96%] w-[124.82%]" src={imgGeminiGeneratedImageGrxp12Grxp12GrxpPhotoroom1} />
          </div>
      ...
      <div className="absolute content-stretch flex items-center left-[121px] size-[20px] top-[551px]" data-name="oranges">
        <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Gemini_Generated_Image_grxp12grxp12grxp-Photoroom 1">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[122.07%] left-[-12.87%] max-w-none top-[-8.96%] w-[124.82%]" src={imgGeminiGeneratedImageGrxp12Grxp12GrxpPhotoroom1} />
          </div>
      ...
      <div className="absolute content-stretch flex items-center left-[135px] size-[20px] top-[556px]" data-name="oranges">
        <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Gemini_Generated_Image_grxp12grxp12grxp-Photoroom 1">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[122.07%] left-[-12.87%] max-w-none top-[-8.96%] w-[124.82%]" src={imgGeminiGeneratedImageGrxp12Grxp12GrxpPhotoroom1} />
          </div>
