...
function Input() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="input">
      <p className="font-['Pretendard:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#b9b9b9] text-[20px] text-center whitespace-nowrap">이름을 입력해주세요</p>
    </div>
  );
}
...
export default function IntroCatname() {
  return (
    <div className="bg-[#fff7ef] content-stretch flex flex-col gap-[10px] items-start overflow-clip relative rounded-[49px] size-full" data-name="intro_catname1">
      <FixBar />
      <Container />
    </div>
  );
