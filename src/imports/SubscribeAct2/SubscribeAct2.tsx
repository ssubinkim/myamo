...
function Frame() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0">
      <p className="font-['Pretendard:Regular',sans-serif] leading-none not-italic relative shrink-0 text-[#1e293b] text-[18px] text-center whitespace-nowrap">연간 구독</p>
    </div>
  );
}
...
function Top() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center relative shrink-0 w-full" data-name="top">
      <Top1 />
      <Frame2 />
    </div>
  );
