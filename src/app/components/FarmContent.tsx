import svgPaths from "../../imports/Farm-2/svg-zql17vv98f";
import imgImage66 from "../../imports/Farm-2/87adc94d946d5f01a118bdf85656fb280efffe30.png";
import imgBell1 from "../../imports/Farm-2/7b28644c182a0d74ea5981876b0670c2a275a5fd.png";
import imgTree from "../../imports/Farm-2/1a3505b49465bb9c4bf256238088b7336258d9ec.png";
import imgCalendar from "../../imports/Farm-2/fe366c9a084584fd1807e1a2faf56ad2cbdef12a.png";
import imgPencil1 from "../../imports/Farm-2/1f319363e649c5324a56c04542d9ec8632dfef35.png";
import imgHome1 from "../../imports/Farm-2/be7abaa5618478279c2675e88d6e9acf59518a6c.png";
import imgShop from "../../imports/Farm-2/1ae31fc4343b04de571e86121deb24224f6c66a0.png";
import imgDairy1 from "../../imports/Farm-2/ccab501880a2fee15f9025884b3fd44918cc3d9b.png";
...
function Button({ onClick }: { onClick: () => void }) {
  return (
    <button onClick={onClick} className="content-stretch flex flex-col items-start relative rounded-[22369600px] shrink-0" data-name="Button">
      <Icon />
    </button>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[14px] items-center justify-end relative shrink-0">
      <div className="flex flex-row items-center self-stretch">
        <div className="content-stretch flex h-full items-center relative shrink-0 w-[20px]" data-name="Component 8">
          <div className="aspect-[391/518] flex-[1_0_0] min-w-px relative" data-name="image 66">
...
function Ul({ onCalendarClick, onWriteClick, onHomeClick, onProfileClick }: { onCalendarClick: () => void; onWriteClick: () => void; onHomeClick: () => void; onProfileClick: () => void }) {
  return (
    <div className="content-stretch flex items-center justify-between p-[30px] relative rounded-[16px] shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] shrink-0 w-[390px]" data-name="ul">
      ...
      <button onClick={onProfileClick} className="content-stretch flex items-center relative shrink-0 size-[50px]" data-name="Component 9">
