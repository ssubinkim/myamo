...
export function IntroSplashContent({ onComplete }: IntroSplashContentProps) {
  ...
  return (
    <div 
      onClick={handleClick}
      className="bg-[#fff7ef] content-stretch flex flex-col gap-[10px] items-start overflow-clip relative rounded-[49px] h-full cursor-pointer" 
              ...
              <>
                ...
                <div className="absolute content-stretch flex h-[23px] items-center left-[180px] top-[352px] w-[25px]" data-name="oranges">
                  <div className="flex-[1_0_0] h-full min-w-px relative" data-name="Gemini_Generated_Image_grxp12grxp12grxp-Photoroom 1">
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                      <img alt="" className="absolute h-[122.07%] left-[-12.87%] max-w-none top-[-8.96%] w-[124.82%]" src={imgOrange} />
                    </div>
                  </div>
                </div>
